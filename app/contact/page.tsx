        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="flex justify-center lg:justify-start order-2 lg:order-1">
              ...
              >
                <div>
                  <p className="text-lg font-semibold" style={{ color: '#348981' }}>Contact Us Hero Image</p>
                  <p className="text-sm text-gray-500 mt-2">contact-hero.png</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 text-left">
              ...
              <p className="text-base sm:text-lg leading-relaxed mb-4" style={{ color: '#5A6C7D' }}>
                Have questions about our services? Ready to discuss your financial needs? Our team is here to help and excited to learn more about your business.
              </p>
