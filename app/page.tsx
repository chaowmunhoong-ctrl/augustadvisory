          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                Follow August Advisory WhatsApp Channel
              </a>
            ...
            <div className="lg:col-span-1 flex flex-col gap-3">
              {[
                ...
                { icon: '🏢', label: 'LHDN, SSM & Customs Announcements' },
                { icon: '✅', label: 'Compliance Tips & Alerts' },
                { icon: '💡', label: 'Insights for SME Owners' },
              ].map((item) => (
                <div
                  key={item.label}
                  className="flex items-center gap-4 px-5 py-4 rounded-xl bg-white shadow-sm"
                >
                  <span className="text-2xl">{item.icon}</span>
                  <span className="text-sm font-semibold" style={{ color: '#2C3E50' }}>{item.label}</span>
                </div>
              ))}
            </div>
