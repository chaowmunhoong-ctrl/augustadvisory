        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <div className="rounded-2xl p-8 w-full max-w-sm" style={{ backgroundColor: '#E8F5F3' }}>
                <div className="flex items-center gap-4 mb-6 pb-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  ...
                  <div>
                    <p className="font-bold text-sm" style={{ color: '#2C3E50' }}>August Advisory</p>
                    <p className="text-xs mt-0.5" style={{ color: '#5A6C7D' }}>WhatsApp Channel</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.label} className="flex items-center gap-3 px-4 py-3 rounded-lg bg-white">
                      ...
                      <span className="text-sm font-medium" style={{ color: '#2C3E50' }}>{item.label}</span>
                    </div>
                  ))}
                </div>
              </div>
