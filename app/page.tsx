        ...
        <div className="max-w-6xl mx-auto">
          <div className="rounded-2xl overflow-hidden grid md:grid-cols-2 items-center" style={{ backgroundColor: '#F0FFFE', border: '2px solid #25D366' }}>
            ...
            <div className="p-8 sm:p-12">
              <p className="text-lg font-bold tracking-widest uppercase mb-4" style={{ color: '#25D366' }}>FREE WHATSAPP CHANNEL</p>
              ...
              <p className="text-base sm:text-lg leading-relaxed mb-6" style={{ color: '#5A6C7D' }}>
                Join our free WhatsApp Channel for timely updates on tax changes, SST, Companies Act, and government regulations, plus practical insights to help your business stay compliant and informed.
              </p>
