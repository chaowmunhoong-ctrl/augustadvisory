...
export default function Home() {
  return (
    <div style={{ backgroundColor: '#F0FFFE' }}>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6" style={{ backgroundColor: '#2C3E50' }}>
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg leading-relaxed mb-8" style={{ color: '#A8BBC8' }}>
            ...
            <div className="flex justify-center">
              <div className="rounded-2xl p-8 w-full max-w-sm" style={{ backgroundColor: '#1a2d3d' }}>
                <div className="flex items-center gap-4 mb-6 pb-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  <div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#348981' }}>
                  ...
                  <div>
                    ...
                    <p className="text-xs mt-0.5" style={{ color: '#A8BBC8' }}>WhatsApp Channel</p>
                  </div>
                </div>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item.label} className="flex items-center gap-3 px-4 py-3 rounded-lg" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }}>
                      ...
                      <span className="text-sm font-medium" style={{ color: '#CBD5E0' }}>{item.label}</span>
                    </div>
                  ))}
                </div>
              </div>
